...
namespace common.code.register
{
    public static class LicenceHelper
    {
        ...
        public static void WriteLicenceFile(string file, string text)
        {
        ...
        {
            return QuickCommand.resource.StringResouce.ResourceManager.GetString(resourceName);
        }

        public static KeyValuePair<string, string> GetPublicPrivateKey()
        {
        ...
        /// <returns></returns>
        public static string GenerationCertificate(string head, string code)
        {
            string privatekey = GetResource(head + "privatekey");
